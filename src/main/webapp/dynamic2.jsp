...
<body>
                                            ...
                                            <div class="col-sm-8">
												...
												<form action="/Servlet01" method="get"> 
                                                    <div class="qty d-flex pt-2">
                                                        ...
                                                        <button id="DelBut" type="submit" class="btn font-baloo text-danger px-3 border-right" name="button" value="DeleteButton">Delete button</button>
    ...
    <script>
        function EnterName()
        {
            var x= document.getElementById("DelBut").value;
  
            document.getElementById("DelBut").innerHTML = 
