...
<br>
	...
	<%if(!order.completed){ %>
		<form action="welcome" method="get">
			<button type="submit" name="SetAsCompleted" value=<%=order.cartNo %>>Confirm Delivery</button>
		</form>
	<br>
	<%} %>
	<form action="welcome" method="get">
			<button type="submit" name="SubmitOrEditFeedback" value=<%=order.cartNo %>>Submit Or Edit Feedback</button>
	</form>
<br>
<br>
<br>
